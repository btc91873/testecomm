...
describe('Cartline', () => {
    ...
    it('renders correctly with promo-code', async () => {
        ...
        promoCode.find('.msc-promo-code__input-box').simulate('change', { target: { value: '1234 ' } });
        promoCode.find('button.msc-promo-code__apply-btn').simulate('click');
        ...
        promoCode.find('.msc-promo-code__input-box').simulate('change', { target: { value: '12 34' } });
        promoCode.find('button.msc-promo-code__apply-btn').simulate('click');
        expect(spyAddPromoCode).toHaveBeenCalled();
        await flushPromises();
        const error = promoCode.find('p');
        expect(error.text()).toBe('Invalid promo code');
    });
});
